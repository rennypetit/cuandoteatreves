...
class es_widget_register extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<div>
			<form class="es_widget_form" data-es_form_id="es_widget_form subscrib">
				<?php if( $es_desc != "" ) { ?>
				...
				<?php if( $es_name == "YES" ) { ?>
					...
					<div class="es_textbox">
						<input type="text" id="es_txt_name" class="es_textbox_class form-suscribir" name="es_txt_name" value="" maxlength="40">
					</div>
				<?php } ?>
				<div class="es_lablebox"><label class="es_widget_form_email"><?php echo __( '', ES_TDOMAIN ); ?></label></div>
			<div id="suscribirse">
				<div class="es_te">
					<input type="email" id="es_txt_email" class="form-suscribir" name="es_txt_email"  value="" maxlength="40" required>
				</div>
				...
				<div class="es_button">
					<!-- <input type="submit" id="es_txt_button" class="es_textbox_button es_submit_button" name="es_txt_button" value=""> -->
						<button type="submit" id="es_txt_button" name="es_txt_button" class="boton-suscribir"><i class="fa fa-arrow-right"></i></button>
				</div>
			</div>
